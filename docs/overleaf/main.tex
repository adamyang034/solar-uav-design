...
\begin{figure}[htbp]
  ...
  \caption{24\,h march starting full at the last afternoon surplus. The pack crosses 20\% and bottoms at $\mathrm{SOC}=0.036$, then refills only to $0.887$. Margin $-158\,\mathrm{Wh}$. Unmet energy is 0\,Wh --- the miss is the reserve, not a blackout.}
